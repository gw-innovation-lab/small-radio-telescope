...
app.layout = html.Div([
    ...
    html.Div(
            ...
            children=[
                    ...
                    html.A(html.Img(src="https://physics.columbian.gwu.edu/sites/g/files/zaxdzs3156/f/image/Header_Centered_Physics.png"),
                    href="https://physics.columbian.gwu.edu/")
                    ],
        className="banner"
    ),
...
def serial_monitor(intervals):
    status = (
        "This software was developed by Caden Gobat at the George Washington University Department of Physics Innovation Lab to control the GW Small Radio Telescope."
    )
